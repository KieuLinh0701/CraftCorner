	...
	<div class="container">
		<div class="row margin-bottom-40">
			...
			<div class="col-md-12 col-sm-12">
				<form
					action="${pageContext.request.contextPath}/admin/design/insert"
