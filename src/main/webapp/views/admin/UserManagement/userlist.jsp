...
<a class="btn btn-default add2cart" href="${pageContext.request.contextPath }/views/admin/adminsmanage/adminadd.jsp">Add
	User</a>
		...
		<div class="goods-data clearfix">
			<div class="table-wrapper-responsive">
				<table>
					...
					<td>${cus.fullname}</td>
					<td>
    <img src="${pageContext.request.contextPath}/assets/img/avatarUser.png" alt="Image" style="width: 100px; height: 100px;">
</td>	
					...
					<td class="goods-page-description">${cus.phone}</td>
					<td class="goods-page-description">${cus.address.city} ${cus.address.district} ${cus.address.ward} ${cus.address.detail}
</td>
