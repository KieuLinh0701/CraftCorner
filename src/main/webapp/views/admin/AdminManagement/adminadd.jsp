	...
	<div class="content-form-page">
		<div class="row">
			<div class="col-md-7 col-sm-7">
				...
				<form action="${pageContext.request.contextPath}/admin/adminsmanage/insert"
					...
					<fieldset>
						...
						<div class="form-group">
							<label for="city" class="col-lg-4 control-label">
								City/Province<span class="require">*</span>
							</label>
							<div class="col-lg-8">
						...
						<div class="form-group">
							<label for="ward" class="col-lg-4 control-label">
								Ward/Commune <span class="require">*</span>
							</label>
							<div class="col-lg-8">
