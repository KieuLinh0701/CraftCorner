...
<div class="col-md-12 col-sm-12">
	<div class="content-form-page">
		<div class="row">
			<h3 class="text-center">CONSULTATION APPOINTMENT</h3>
			<form action="${pageContext.request.contextPath}/make-appointment"
				method="post" class="form-horizontal" role="form">
				<div class="form-group">
					<label for="appointmentDate" class="col-lg-4 control-label">
						Appointment Time <span class="require">*</span>
					</label>
					<div class="col-lg-8">
					...
					<div class="row">
						<div
							...
							<button type="submit" class="registerbtn"
								style="background-color: black; height: 40px; width: 180px; color: white; font-size: 15px">BOOK
								NOW</button>
						</div>
					</div>
				</div>
