...
<section class="bg-dark text-white py-5 text-center position-relative"
	style="background-image: url('https://cdn.media.amplience.net/i/shadesoflight/XU_Cat3'); background-size: cover;">
	<div class="container position-relative">
		<h1 class="position-absolute text-overlay">Các thiết kế mẫu</h1>
		<p class="lead position-absolute text-overlay-desc">Mang đến những
			ý tưởng sáng tạo và phong cách nội thất tinh tế dành riêng cho không
			gian sống của bạn</p>
	</div>
</section>
...
<form action="designs" method="get" class="container mt-4">
	<div class="row g-3">
		...
		<div class="col-md-3">
			<label for="productName" class="form-label">Tìm theo sản phẩm</label>
	...
	<div class="row g-3 mt-3">
		...
		<div class="col-md-3">
			<a href="designs" class="btn btn-secondary w-100">Hiển thị tất cả</a>
		</div>
	</div>
</form>
